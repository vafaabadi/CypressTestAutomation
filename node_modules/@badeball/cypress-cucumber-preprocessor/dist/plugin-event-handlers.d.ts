...
export declare function testCaseStartedHandler(config: Cypress.PluginConfigOptions, data: ITaskTestCaseStarted): boolean;
...
export declare function createStringAttachmentHandler(config: Cypress.PluginConfigOptions, { data, mediaType, encoding }: ITaskCreateStringAttachment): Promise<boolean>;
